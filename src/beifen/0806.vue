        ...
        <div class="center-blank">
          <div class="projection-row">
            ...
            <div class="projection-panel">
              <div class="panel-header">
                ...
                <div class="panel-tools">
                  ...
                  <button
                    ...
                    :disabled="!promptLassoMode || promptLassoResults.length === 0"
                    title="应用套索选择"
                  >选择</button>
                </div>
              </div>
              ...
              <div class="projection-legend-corner">
              ...
              <div class="panel-header">
                  ...
                  <div class="panel-tools">
                    ...
                    <button
                      ...
                      :disabled="!corpusLassoMode || corpusLassoResults.length === 0"
                      title="应用套索选择"
                    >选择</button>
                  </div>
                </div>
...
const selectedAttackMethods = ref([])
