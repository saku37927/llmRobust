        ...
        <div class="right-list horizontal-lists">
          <div class="prompt-list horizontal-list-item">
            ...
            <div v-else class="scrollable-list">
              <div v-for="item in currentPrompts" :key="item.id" class="list-item row-flex">
                <div class="item-content">{{ item.text }}</div>
                <div class="item-robustness">{{ item.robustness }}</div>
              </div>
            </div>
          </div>
          <div class="corpus-list horizontal-list-item">
            ...
            <div v-else class="scrollable-list">
              <div v-for="item in currentCorpus" :key="item.id" class="list-item row-flex">
                <div class="item-content">{{ item.text }}</div>
                <div class="item-robustness">{{ item.robustness }}</div>
              </div>
            </div>
