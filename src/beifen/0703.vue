<template>
      ...
      <div class="middle-row">
        ...
        <div class="center-blank">
          ...
          <div class="blank-content">
            <div class="blank-list-container">
              <!-- Prompt列表，靠左 -->
          ...
          <div class="center-blank">
            <div class="projection-row">
              ...
              <div class="projection-panel">
                <div class="panel-header">Prompt 投影</div>
                <div class="panel-content">
                  <svg :width="projectionWidth" :height="projectionHeight" @click="hidePromptTooltip">
                    <g v-for="item in currentPrompts" :key="item.id">
                      <circle
                        ...
                        :r="5"
                        :fill="robustnessColorStyle(item.robustness).color"
                    ...
                    <g v-if="promptTooltip.visible">
                      <rect
                        :x="promptTooltip.screenX + 10"
                        :y="promptTooltip.screenY - 30"
                        width="220"
                        height="60"
                        rx="8"
                        fill="#fff"
                        ...
                        filter="url(#shadow)"
                      />
                      <text :x="promptTooltip.screenX + 20" :y="promptTooltip.screenY - 10" font-size="14" fill="#222">ID: {{ promptTooltip.data.id }}</text>
                      <text :x="promptTooltip.screenX + 20" :y="promptTooltip.screenY + 10" font-size="13" fill="#555">鲁棒性: {{ promptTooltip.data.robustness }}</text>
                      <text :x="promptTooltip.screenX + 20" :y="promptTooltip.screenY + 30" font-size="13" fill="#333" style="font-family:monospace;" :textLength="180" lengthAdjust="spacingAndGlyphs">{{ promptTooltip.data.text }}</text>
                    </g>
                    <defs>
              ...
              <!-- B区：Corpus投影 -->
              <div class="projection-panel">
                <div class="panel-header">Corpus 投影</div>
                <div class="panel-content">
                  <svg :width="projectionWidth" :height="projectionHeight" @click="hideCorpusTooltip">
                    ...
                    <g v-if="corpusTooltip.visible">
                      <rect
                        :x="corpusTooltip.screenX + 10"
                        :y="corpusTooltip.screenY - 30"
                        width="220"
                        height="60"
                        rx="8"
                        fill="#fff"
                        ...
                        filter="url(#shadow)"
                      />
                      <text :x="corpusTooltip.screenX + 20" :y="corpusTooltip.screenY - 10" font-size="14" fill="#222">ID: {{ corpusTooltip.data.id }}</text>
                      <text :x="corpusTooltip.screenX + 20" :y="corpusTooltip.screenY + 10" font-size="13" fill="#555">鲁棒性: {{ corpusTooltip.data.robustness }}</text>
                      <text :x="corpusTooltip.screenX + 20" :y="corpusTooltip.screenY + 30" font-size="13" fill="#333" style="font-family:monospace;" :textLength="180" lengthAdjust="spacingAndGlyphs">{{ corpusTooltip.data.text }}</text>
                    </g>
                  </svg>
                </div>
              </div>
            ...
            <div class="projection-legend-vertical">
              <svg :width="45" :height="legendVHeight">
                <g v-for="(val, idx) in legendVValues" :key="idx">
                  <rect x="10" :y="10 + idx * (legendVBlockHeight + legendVGap)" width="22" :height="legendVBlockHeight" :fill="robustnessColorStyle(val).color" stroke="#ccc" rx="2" />
  ...
  function projectX(x, type) {
    ...
    return ((x-minX)/(maxX-minX))* (projectionWidth-40) + 20
  }
  function projectY(y, type) {
    const [minY, maxY] = type==='prompt' ? promptYRange.value : corpusYRange.value
    return ((y-minY)/(maxY-minY))* (projectionHeight-40) + 20
  }
  ...
  function showPromptTooltip(item) {
    promptTooltip.visible = true
    promptTooltip.data = item
    promptTooltip.screenX = projectX(item.x, 'prompt')
    promptTooltip.screenY = projectY(item.y, 'prompt')
  ...
  function showCorpusTooltip(item) {
    corpusTooltip.visible = true
    corpusTooltip.data = item
    corpusTooltip.screenX = projectX(item.x, 'corpus')
    corpusTooltip.screenY = projectY(item.y, 'corpus')
  ...
  function onCorpusSvgMousedown(e) {
    ...
    corpusdragStart = {x: e.offsetX, y: e.offsetY}
  ...
  function onCorpusSvgMousemove(e) {
    ...
    const dx = e.offsetX - corpusdragStart.x
    const dy = e.offsetY - corpusdragStart.y
  ...
  function onPromptLassoDown(e) {
    ...
    promptLassoPoints.value = [[e.offsetX, e.offsetY]]
  ...
  function onPromptLassoMove(e) {
    promptLassoPoints.value.push([e.offsetX, e.offsetY])
  }
  ...
  function onCorpusLassoDown(e) {
    ...
    corpusLassoPoints.value = [[e.offsetX, e.offsetY]]
  ...
  function onCorpusLassoMove(e) {
    corpusLassoPoints.value.push([e.offsetX, e.offsetY])
  }
